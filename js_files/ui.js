export class UI {
    ...
    draw(context){
        ...
        //guide 
         context.fillText(`Press SpaceBar to Kill`,  410, 33);
        ...
        if (this.game.gameOver) {
            ...
            if (this.game.score > 50){
                context.fillText(`Chicken Dinner!`, this.game.width * 0.5, this.game.height * 0.5 - 20);
                ...
                context.fillText(`Well Well Well!`, this.game.width * 0.5, this.game.height * 0.5 - 20);
                // context.font = this.fontSize * 0.7 + 'px ' + this.fontFamily;
