...
import { CollisionAnimation } from "./collition.js";
...
export class Player {
    constructor(game){
        ...
        this.image = document.getElementById('play');
        this.frameX = 0;
        this.frameY = 0;
        this.maxFrame = 0; 
        this.fps = 24;
    ...
    update(input, deltaTime){
        ...
        else if (input.includes('ArrowLeft') && this.currentState !== this.states[6]) this.speed = -this.maxSpeed*3;
        else this.speed = 0;
    ...
    draw(context){
        ...
        context.drawImage(this.image, this.frameX * this.width, this.frameY * this.height, this.width, this.height, this.x, this.y, this.width+50, this.height+50)
    }
    onGround(){
